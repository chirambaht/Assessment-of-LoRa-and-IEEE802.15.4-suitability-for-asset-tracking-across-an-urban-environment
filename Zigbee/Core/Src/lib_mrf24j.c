...
void mrf_prep_sleep(){
	mrf_write_short(MRF_WAKECON, 0x80);
}
void mrf_sleep(){
	mrf_prep_sleep();
	mrf_write_short(MRF_SOFTRST, 0x04);
	mrf_write_short(MRF_SLPACK, 0x80);
}


void mrf_wakeup(){
	mrf_write_short(MRF_WAKECON, 0xC0);
	mrf_write_short(MRF_WAKECON, 0x80);
	mrf_write_short(MRF_RFCTL, 0x04);
